  ...
  return (
    <div className="register container m-auto  text-blue-900 font-bold ">
      ...
      <div
       ...
       className="model fixed top-0 left-0 right-0 bottom-0 z-10 flex justify-center content-center">
          <div className="model-container w-96 h-80 flex justify-center content-center">
            <h3 className="text-2xl">Bạn đã đăng ký thành công</h3>
          </div>
      </div>}
