...
function Form() {
  ...
  return (
    <div className="h-screen register container m-auto  text-blue-900 font-bold  flex items-center justify-center">
      <div id="toast">
        {openToast && (
          <div className="toast text-green-500 fixed top-6 right-6  z-10 border-l-4 bg-white p-5 border-green-500">
            {message}
          </div>
        )}
      </div>
      ...
      <form
        method="get"
        action=""
        className=" w-full p-10 bg-white max-w-sm m-auto shadow"
      >
        ...
        <button
          ...
          className="mt-8 w-full max-w-md bg-blue-900 text-white pt-4 pb-4 rounded-xl"
          type="submit"
        >
          Submit
        </button>
