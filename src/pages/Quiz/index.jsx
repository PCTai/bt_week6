...
function Quiz() {
  ...
  return (
    <div className="quiz container w-full m-auto pt-28 ">
      {open && (
        <div className="model fixed top-0 left-0 right-0 bottom-0 z-10 flex justify-center items-center">
          <div className="model-container w-96 h-80 flex justify-center flex-col items-center bg-white shadow-md">
            ...
            <button
              ...
              className="mt-8 pl-10 pr-10 bg-blue-900 text-white pt-4 pb-4 rounded-xl"
            >
              OK
            </button>
          </div>
      ...
      <div className="quiz-content flex  justify-center mt-10 p-6">
        <div className="answer w-80">
          <h3 className="text-xl font-bold mb-6">
            Question {index}: {questions[index - 1].question} ?
          </h3>
          {answers.map((item, index) => (
            <div
              onClick={() => handleChooseAnswer(item, index)}
              key={item}
              className={`itemAnswer p-2 bg-white mb-4 cursor-pointer hover:bg-gray-300 ${
                active === index + 1 ? "bg-gray-300" : ""
              }`}
            >
              {item}
            </div>
        ...
        <div className="quiz-right pl-8 ">
          ...
          <div className="directiry flex justify-between">
            <button
              ...
              className={`${
                index <= 1 ? "opacity-10" : ""
              } block rounded-lg pt-2 pb-2 pr-6 pl-6 bg-blue-900 text-white`}
            ...
            <button
              onClick={handleNext}
              className={`${
                index === length || active === 0 ? "opacity-10" : ""
              } block rounded-lg pt-2 pb-2 pr-6 pl-6 bg-blue-900 text-white`}
          ...
          <button
            ...
            className={`${
              index <= length - 1 || active === 0 ? "opacity-10" : ""
            } block mt-10 rounded-lg pt-2 pb-2 pr-6 pl-6 bg-blue-900 text-white`}
          >
            Submit
          </button>
          <button
